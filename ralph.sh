...
IMPORTANT 2 - STOP CODES: You MUST output one of these stop codes when the corresponding condition is met (but you should NOT output any of these codes until the condition is met):

- $COMPLETE_MARKER -- Output when ALL phases and sections in the entire implementation guide are complete.
