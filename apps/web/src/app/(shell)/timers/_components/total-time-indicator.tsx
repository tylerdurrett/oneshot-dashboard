...
export function TotalTimeIndicator({
  ...
  return (
    <div
      ...
      className="relative h-10 shrink-0 mx-2 mt-2 rounded-md overflow-hidden"
    >
      ...
      />
      <span className="relative z-10 flex h-full items-center justify-between px-3 text-xs font-medium tabular-nums text-zinc-300">
